...
python train.py --config configs/modnet/modnet_mobilenetv2_bgsdata.yml --do_eval --use_vdl --save_interval 10000 --save_dir output_mv2 --log_iters 500 --num_workers 16
