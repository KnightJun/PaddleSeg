...
python train.py --config configs/modnet/modnet_hrnet_w18_bgsdata.yml --do_eval --use_vdl --save_interval 5000 --save_dir output --params_preload ./model_old.pdparams --log_iters 100 --num_workers 16
