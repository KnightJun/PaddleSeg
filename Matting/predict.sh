...
python tools/predict.py --config configs/modnet/modnet_hrnet_w18_bgsdata.yml --model_path params/modnet.pdparams --image_path test_images --save_dir ./output/results --fg_estimate False --add_opt CheckNcnnOnnx
